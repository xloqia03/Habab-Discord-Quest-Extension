# Privacy Policy for Habab Discord Quest Extension

**Last Updated:** 28/8/2026

## Introduction
Habab Discord Quest Extension ("the Extension") is a browser extension developed by **Xloqia03** that automatically completes Discord quests in the web browser without any manual work. This privacy policy explains how the Extension handles user data and information.
...
* Requires community membership verification to ensure safe access for authorized members.
...
## Contact
If you have any questions about this privacy policy or the Extension's data practices, please contact us through the GitHub repository at [Habab-Discord-Quest-Extension](https://github.com/xloqia03/Habab-Discord-Quest-Extension) or through our official community server ( https://discord.gg/hababagency ).

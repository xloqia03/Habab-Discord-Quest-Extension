(function() {
  ...
  const HABAB_INVITE = 'https://discord.gg/hababagency';
  ...
  function showVerificationPanel(
    ...
    const existingPanel =
      document.getElementById('HababVerificationPanel');
    ...
    panel.innerHTML = `
      ...
      <div
        ...
        "
      >
        Join the server, then press Verify.
      </div>
    `;
    ...
    const joinButton =
      document.getElementById('HababJoinButton');
    ...
    const verifyButton =
      document.getElementById('HababVerifyButton');
    ...
    verifyButton.addEventListener(
      ...
      async () => {
        ...
        try {
          ...
          const isMember =
            await checkHababMembership();


          if (!isMember) {

            status.textContent =
              'You are not a member yet. Join the server first.';
  ...
  // =========================================================
  // CHECK HABAB MEMBERSHIP
  // =========================================================

  async function checkHababMembership() {
  ...
  function createExpandedPanel() {
    ...
    const questListContainer =
      document.createElement('div');


    questListContainer.id =
      'DiscordQuestList';


    questListContainer.style.cssText =
      STYLES.questList;
    ...
    credit.style.cssText =
      'margin: 0; font-size: 14px; color: #ccc;';
  ...
  function togglePanel() {
    ...
    if (expandButtonReference) {
      ...
      expandButtonReference.style.transform =
        isPanelExpanded
          ? 'rotate(180deg)'
          : 'rotate(0deg)';
    }
